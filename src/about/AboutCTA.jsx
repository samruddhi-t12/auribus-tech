          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12">
            ...
            <Link to="/contact">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-3 px-8 py-4 rounded-full bg-sky-500 text-white text-lg font-medium tracking-wide shadow-lg hover:bg-sky-400 transition-colors"
              >
                <FaCalendarAlt />
                Schedule a call 
              </motion.button>
